...
class Pharmacy:
    def __init__(self, root):
        ...
        self.root.iconbitmap(r"C:\Images\p_logo.ico")
        ...
        ######### pharmacy logo label #######
        img1 = Image.open(r"C:\Users\ApurvaN\OneDrive\Pictures\p_logo.jpg")
        img1 = img1.resize((70, 45), Image.Resampling.LANCZOS)
        ...
        add_button = Button(down_buttonframe, text="Add Medicine", command=self.addmedicine, font=(
            "arial", 12, "bold"), width=14, fg="white", bg="purple", bd=3, relief=RIDGE, activebackground="purple",
                            activeforeground="red")
        add_button.grid(row=0, column=0)

        update_button = Button(down_buttonframe, command=self.update_new, text="Update", font=(
            "arial", 13, "bold"), width=14, fg="red", bg="yellow", bd=3, relief=RIDGE, activebackground="yellow",
                               activeforeground="blue")
        update_button.grid(row=0, column=1)

        delete_button = Button(down_buttonframe, command=self.delete_new, text="Delete", font=("arial", 13, "bold"), width=13,
        ...
        reset_button = Button(down_buttonframe, text="Reset", command=self.clear_new, font=("arial", 13, "bold"),
                              width=12,
                              fg="white", bg="darkgreen", bd=3, relief=RIDGE, activebackground="darkgreen",
                              activeforeground="yellow")
        reset_button.grid(row=0, column=3)

        exit_button = Button(down_buttonframe, command=self.root.quit, text="Exit", font=(
            "arial", 13, "bold"), width=10, fg="black", bg="grey", bd=3, relief=RIDGE, activebackground="grey",
                             activeforeground="red")
        ...
        search_button = Button(down_buttonframe, text="Search", font=("arial", 13, "bold"), width=10, fg="red",
                               bg="violet",
                               bd=3, relief=RIDGE, activebackground="violet", activeforeground="blue",
        ...
        show_button = Button(down_buttonframe, text="Show All", font=("arial", 13, "bold"), fg="blue", bg="yellow",
                             width=10, bd=3, relief=RIDGE, activebackground="yellow", activeforeground="red",
        ...
        self.medname_combo["values"] = row_02
        self.medname_combo["values"] = row_02
        self.medname_combo["values"] = row_02
        self.medname_combo["values"] = row_02
        self.medname_combo["values"] = row_02
        ...
        # image 1
        self.bg = ImageTk.PhotoImage(file=r"C:\Users\ApurvaN\OneDrive\Pictures\med.jpg")
        lbl_bg = Label(left_smallframe, image=self.bg)
        lbl_bg.place(x=370, y=165, width=200, height=150)
        # image 2
        self.bgg = ImageTk.PhotoImage(file=r"C:\Users\ApurvaN\OneDrive\Pictures\medi.jpg")
        ...
        # image 1
        self.bg1 = ImageTk.PhotoImage(file=r"C:\Users\ApurvaN\OneDrive\Pictures\co.jpeg")
        lbl_bg1 = Label(right_frame, image=self.bg1)
        lbl_bg1.place(x=0, y=0, width=240, height=100)
        # image 2
        self.bg2 = ImageTk.PhotoImage(file=r"C:\Users\ApurvaN\OneDrive\Pictures\inject.jpg")
        ...
        updatenew_button = Button(newframe, text="Update", font=("arial", 13, "bold"), width=13, fg="red", bg="yellow",
                                  bd=3, command=self.Update_med, relief=RIDGE, activebackground="yellow",
                                  activeforeground="blue")
        updatenew_button.grid(row=1, column=0)

        delnew_button = Button(newframe, text="Delete", font=("arial", 13, "bold"), width=13, fg="blue", bg="red",
                               bd=3, relief=RIDGE, activebackground="red", activeforeground="blue",
        ...
        clr_button = Button(newframe, text="Clear", command=self.clear_med, font=("arial", 13, "bold"), width=13,
                            fg="red", bg="purple", bd=3, relief=RIDGE, activebackground="purple",
                            activeforeground="blue")
        ...
        self.info_table.heading("product", text="Qt.")
    ...
    def addmedicine(self):
        ...
        elif self.expdt_var.get() < self.issuedt_var.get():
            messagebox.showinfo("Error", "Change Expiry date")
    ...
    def update_new(self):
        ...
        if self.refno_var.get() == "" or self.lotno_var.get() == "" or self.typemed_var.get() == "":
            ...
            new_cursor = conn.cursor()
            new_cursor.execute(
                "Update Information set COMPANY_NAME=?,TYPE_OF_MED=?,MED_NAME=?,LOT_NO=?,ISSUE_DT=?,EXP_DT=?,USES=?,SIDE_EFFECT=?,PRECAUTION=?,DOSAGE=?,PRICE=?,QUANTITY=? where REF_NO=?",
                (
    ...
    def delete_new(self):
        ...
        try:
            ...
            new_cursor.execute("Delete from Information where Ref_no=? ",(self.refno_var.get(),))
            conn.commit()
